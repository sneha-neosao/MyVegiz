...
class _GroceryTabWidgetState extends State<GroceryTabWidget> {
  ...
  void initState() {
    ...
    super.initState();
    _vegetableSliderBloc = getIt<VegetableSliderBloc>()..add(VegetableSliderGetEvent(widget.cityCode, "MCAT_2"));
    _vegetableCategoryBloc = getIt<VegetableCategoryBloc>()..add(VegetableCategoryGetEvent("0", "MCAT_2"));
  }
